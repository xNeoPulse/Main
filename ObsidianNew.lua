...
local CustomImageManagerAssets = {
    TransparencyTexture = {
        ...
        Path = "NeoPulse Hub/assets/TransparencyTexture.png",
    ...
    SaturationMap = {
        RobloxId = 4155801252,
        Path = "NeoPulse Hub/assets/SaturationMap.png",
    ...
    LoadingIcon = {
        ...
        Path = "NeoPulse Hub/assets/LoadingIcon.png",
    ...
    CheckIcon = {
        ...
        Path = "NeoPulse Hub/assets/CheckIcon.png",
...
do
    ...
    function CustomImageManager.AddAsset(
        ...
        CustomImageManagerAssets[AssetName] = {
            ...
            Path = string.format("NeoPulse Hub/custom_assets/%s", AssetName),
            URL = URL,
...
function Library:MakeOutline(Frame: GuiObject, Corner: number?, ZIndex: number?)
    warn("NeoPulse Hub:MakeOutline is deprecated, please use NeoPulse Hub:AddOutline instead.")
...
function Library:CreateMobileButtons(WindowInfo)
    ...
    if WindowInfo.Icon then
        local function CreateToggle(...)
            ...
            Library:MakeDraggable(Button, Button, true)
            DraggableToggle:SetImage(Image)
            ...
            function DraggableToggle:Destroy()
                DraggableToggle.Destroyed = true

                if DraggableToggle.Connections then
                    for _, connection in DraggableToggle.Connections do
                        connection:Disconnect()
                    end
                end
